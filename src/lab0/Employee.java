...
public class Employee {
    ...
    public final void setFirstName(String firstName) {
        if (firstName == null || firstName.length() < 2) {
            throw new IllegalArgumentException(); // better to use custom
                                                  // Exception
        }
    ...
    /*
        SSNs must be either 9 digits in length or
        11 characters, where the first 3 are digits,
        followed by a hyphen, followed by 2 digits, followed by
        a hyphen, followed by 4 digits, and cannot be null
    */
